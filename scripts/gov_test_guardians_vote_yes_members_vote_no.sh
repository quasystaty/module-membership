...
echo "GOV TEST: Guardians vote yes, Members vote no, Proposal passes"
...
echo "me voting No on proposal $PROPOSAL_ID"
./tx-gas.sh membershipd tx gov vote $PROPOSAL_ID No --from me
